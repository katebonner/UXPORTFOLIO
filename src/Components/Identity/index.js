...
const Identity = () => {
  ...
  const { t, e, k, g, i } = useSpring({
    reset: true,
    from: { t: 0, e: -300, k: 0, g: 0, i: 30, y: 0 },
    to: async (next) => {
      while (true) {
        await next({ t: 1, e: -650, k: 15, g: 20, i: -230, y: 100 });
        await new Promise((resolve) => setTimeout(resolve, 1000)); // delay
        await next({ t: 0, e: -300, k: 0, g: 0, i: 30, y: 0 });
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row" }}>
      <svg viewBox="-5 -5 120 140" style={{ width: "15%" }}>
        <animated.path
      ...
      <div style={{ transform: `translate(-45%, 2%)`, width: "100%" }}>
        <svg
          viewBox="-5 -5 120 140"
          style={{ width: "15%" }}
          stroke={theme.colors.violet[200]}
